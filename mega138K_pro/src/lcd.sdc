...
//Created Time: 2025-06-11 13:48:58
...
create_generated_clock -name serial_clk -source [get_ports {clk}] -master_clock clk -divide_by 5 -multiply_by 37 [get_nets {serial_clk}]
