...
//Created Time: 2025-04-13 22:11:37
...
set_clock_groups -exclusive -group [get_clocks {cmos_pclk}] -group [get_clocks {clk}] -group [get_clocks {serial_clk}] -group [get_clocks {mem_clk}]
