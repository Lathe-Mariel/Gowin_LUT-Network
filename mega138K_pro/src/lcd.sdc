...
//Created Time: 2025-06-09 22:07:33
...
create_generated_clock -name serial_clk -source [get_ports {clk}] -master_clock clk -divide_by 7 -multiply_by 26 [get_nets {serial_clk}]
