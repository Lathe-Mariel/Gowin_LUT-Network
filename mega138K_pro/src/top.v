...
always@(posedge lcd_vs) lcd_vs_cnt <= lcd_vs_cnt + 1;
    ...
    reg cmos_reset;
    reg cmos_start_config;  //for SCCB I2C
...
/*
logic[15:0] tp;
logic [9:0] tp_counter;
localparam	WHITE	= {5'd31 , 6'd63 , 5'd31 };//{B,G,R}
localparam	YELLOW	= {5'd0   , 6'd63 , 5'd31 };
localparam	CYAN	= {5'd31 , 6'd63 , 5'd0   };
localparam	GREEN	= {5'd0   , 6'd63 , 5'd0   };
localparam	MAGENTA	= {5'd31 , 6'd0   , 5'd31 };
localparam	RED		= {5'd0   , 6'd0   , 5'd31  };
localparam	BLUE	= {5'd31 , 6'd0   , 5'd0   };
localparam	BLACK	= {5'd0   , 6'd0   , 8'd0   };
always@(posedge cmos_16bit_wr)begin
    if(!rst_n || (tp_counter > 10'd270))begin
        tp_counter <= 10'd0;
    end else begin
        tp_counter <= tp_counter + 9'd1;
    end
...
//        .I_rst_n(~rst_n),
		...
		.I_wr_halt(~sw0),            //frame buffer interrupt(write) for debug
		.I_rd_halt(~sw1),            //frame buffer interrupt(read) for debug
